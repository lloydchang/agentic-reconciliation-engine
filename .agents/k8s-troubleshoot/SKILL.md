...
# K8S Troubleshoot — Multi-Cloud Enterprise Automation
...
## Scripts
- `scripts/k8s-troubleshoot.py`: Main automation implementation
- `scripts/k8s-troubleshoot_handler.py`: Cloud-specific operations

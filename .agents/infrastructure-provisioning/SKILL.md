...
## When to Use
- **infrastructure provisioning operations** across multi-cloud environments
- **Automation and optimization** of infrastructure provisioning workflows
- **Monitoring and management** of infrastructure provisioning resources
- **Compliance and governance** for infrastructure provisioning activities
...
## Scripts
- `scripts/infrastructure-provisioning.py`: Main automation implementation
- `scripts/infrastructure-provisioning_handler.py`: Cloud-specific operations

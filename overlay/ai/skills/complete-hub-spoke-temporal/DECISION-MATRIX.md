...
- All components from overlay/examples/complete-hub-spoke-temporal/
...
```bash
# Core Temporal only
kubectl apply -f overlay/examples/complete-hub-spoke-temporal/infra/temporal-server.yaml
kubectl apply -f overlay/examples/complete-hub-spoke-temporal/flux/temporal-integration.yaml
...
kubectl apply -f overlay/examples/complete-hub-spoke-temporal/infra/
kubectl apply -f overlay/examples/complete-hub-spoke-temporal/flux/
kubectl apply -f overlay/examples/complete-hub-spoke-temporal/monitoring/
kubectl apply -f overlay/examples/complete-hub-spoke-temporal/security/
```

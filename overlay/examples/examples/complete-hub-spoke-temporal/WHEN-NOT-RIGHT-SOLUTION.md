...
recommended_approach:
  ...
  components:
    ...
    - "Terraform AI for complex resources"
  temporal_components_to_reuse:
...
cp overlay/examples/complete-hub-spoke-temporal/infra/temporal-server.yaml my-temporal/infra/
cp overlay/examples/complete-hub-spoke-temporal/workflows/deployment-workflow.go my-temporal/workflows/
# Skip AI components if not needed
# cp -r overlay/examples/complete-hub-spoke-temporal/skills/ my-temporal/  # Skip for simple automation
```

...
* **Agentic Layer (A):** [Temporal](https://temporal.io/), [SQLite](https://sqlite.org/), [Qwen](https://www.alibabacloud.com/blog/qwen2-5-coder-series-powerful-diverse-practical_601765), [AGENTS.md](https://agents.md/), [SKILL.md](https://agentskills.io/): Complex actions that stateless controllers cannot reconcile.

...
- Create directory structure: backend/, frontend/, core/scripts/automation/, docs/
...
- Create /core/scripts/automation/dev.sh for starting Temporal server and Backstage dev server
- Create /core/scripts/automation/build.sh for building Docker images
...
- Prepare for optional extensions (AI agent integration, multi-cloud hooks, CI/CD)

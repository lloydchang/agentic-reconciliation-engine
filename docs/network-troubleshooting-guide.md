...
**File**: `scripts/network-connectivity-diagnostic.sh`
...
**Usage**:
```bash
./scripts/network-connectivity-diagnostic.sh
```
...
**File**: `scripts/install-crossplane.sh` (Modified)
...
**File**: `scripts/fix-kubectl-version.sh`

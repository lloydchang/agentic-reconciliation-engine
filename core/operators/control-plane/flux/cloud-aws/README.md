...
This overlay groups the AWS-specific network, cluster, and workload manifests that Flux deploys when `./cloud-aws` is listed in `core/operators/flux/kustomization.yaml`.

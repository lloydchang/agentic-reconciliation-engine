#!/usr/bin/env python3
"""
Always-On Memory Agent Dashboard - Qwen2.5 0.5B via Ollama
...
UPLOAD_EXTENSIONS = [
    ...
    # Note: Media files not supported in this version
]
...
SAMPLE_TEXTS = [
    {
        ...
        "text": (
            "Anthropic reports 62% of Claude usage is now "
...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown("**Qwen2.5 0.5B**")
        st.markdown("*via Ollama*")
        st.markdown("---")
    ...
    st.markdown(
        ...
        <p style="color: #666; font-size: 14px; max-width: 600px; margin: 0 auto;">
            ...
            Built with <strong style="color: #93c5fd;">Qwen2.5 0.5B</strong> + <strong style="color: #c4b5fd;">Ollama</strong>.
    ...
    with tab_ingest:
        ...
        st.markdown("<p style='color: #666; font-size: 13px;'>Upload text files (txt, md, json, csv, log, xml, yaml, yml). "

...
## Scripts
- `core/core/automation/ci-cd/scripts/workflow-management.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/workflow-management_handler.py`: Cloud-specific operations

...
## When to Use
- **k8s troubleshoot operations** across multi-cloud environments
- **Automation and optimization** of k8s troubleshoot workflows
- **Monitoring and management** of k8s troubleshoot resources
- **Compliance and governance** for k8s troubleshoot activities
...
## Scripts
- `core/core/automation/ci-cd/scripts/k8s-troubleshoot.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/k8s-troubleshoot_handler.py`: Cloud-specific operations

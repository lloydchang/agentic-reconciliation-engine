...
## Scripts
- `core/core/automation/ci-cd/scripts/database-maintenance.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/database-maintenance_handler.py`: Cloud-specific operations

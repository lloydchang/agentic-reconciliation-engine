...
# Incident Summary — Multi-Cloud Enterprise Automation

## Purpose
Enterprise-grade automation solution for incident summary operations across AWS, Azure, GCP, and on-premise environments to maximize operational efficiency while maintaining security and compliance standards.
...
## Scripts
- `core/core/automation/ci-cd/scripts/incident-summary.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/incident-summary_handler.py`: Cloud-specific operations
- `core/core/automation/ci-cd/scripts/multi_cloud_orchestrator.py`: Cross-provider coordination

## Trigger Keywords
incident, summary, automation, enterprise, multi-cloud, aws, azure, gcp, onprem

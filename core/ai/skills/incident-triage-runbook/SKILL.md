...
description: Automates incident triage processes and executes runbooks based on incident type and severity across cloud environments. Use when handling incidents, coordinating response teams, or implementing incident automation.
license: AGPLv3
metadata:
...
## When to Use
- **incident triage runbook operations** across multi-cloud environments
- **Automation and optimization** of incident triage runbook workflows
- **Monitoring and management** of incident triage runbook resources
- **Compliance and governance** for incident triage runbook activities
...
## Scripts
- `core/core/automation/ci-cd/scripts/incident-triage-runbook.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/incident-triage-runbook_handler.py`: Cloud-specific operations

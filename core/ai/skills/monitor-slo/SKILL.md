...
## When to Use
- **slo monitor operations** across multi-cloud environments
- **Automation and optimization** of slo monitor workflows
- **Monitoring and management** of slo monitor resources
- **Compliance and governance** for slo monitor activities
...
## Scripts
- `core/core/automation/ci-cd/scripts/slo-monitor.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/slo-monitor_handler.py`: Cloud-specific operations

...
## When to Use
- **cost optimizer operations** across multi-cloud environments
- **Automation and optimization** of cost optimizer workflows
- **Monitoring and management** of cost optimizer resources
- **Compliance and governance** for cost optimizer activities
...
## Scripts
- `core/core/automation/ci-cd/scripts/cost-optimizer.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/cost-optimizer_handler.py`: Cloud-specific operations

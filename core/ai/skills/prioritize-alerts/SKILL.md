...
## Scripts
- `core/core/automation/ci-cd/scripts/alert-prioritizer.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/alert-prioritizer_handler.py`: Cloud-specific operations

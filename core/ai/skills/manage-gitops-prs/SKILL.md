...
## When to Use
- **gitops pr operations** across multi-cloud environments
- **Automation and optimization** of gitops pr workflows
- **Monitoring and management** of gitops pr resources
- **Compliance and governance** for gitops pr activities
...
## Scripts
- `core/core/automation/ci-cd/scripts/gitops-pr.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/gitops-pr_handler.py`: Cloud-specific operations

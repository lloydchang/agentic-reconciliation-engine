...
## Scripts
- `core/core/automation/ci-cd/scripts/security-analysis.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/security-analysis_handler.py`: Cloud-specific operations

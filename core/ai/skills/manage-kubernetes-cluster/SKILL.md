...
# Kubernetes Cluster Manager — Multi-Cloud Enterprise Automation

## Purpose
Enterprise-grade automation solution for kubernetes cluster manager operations across AWS, Azure, GCP, and on-premise environments to maximize operational efficiency while maintaining security and compliance standards.

## When to Use
- **kubernetes cluster manager operations** across multi-cloud environments
- **Automation and optimization** of kubernetes cluster manager workflows
- **Monitoring and management** of kubernetes cluster manager resources
...
## Scripts
- `core/core/automation/ci-cd/scripts/kubernetes-cluster-manager.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/kubernetes-cluster-manager_handler.py`: Cloud-specific operations
- `core/core/automation/ci-cd/scripts/multi_cloud_orchestrator.py`: Cross-provider coordination

## Trigger Keywords
kubernetes, cluster, manager, automation, enterprise, multi-cloud, aws, azure, gcp, onprem

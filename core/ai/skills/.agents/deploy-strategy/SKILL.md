...
## When to Use
- **deployment strategy operations** across multi-cloud environments
- **Automation and optimization** of deployment strategy workflows
- **Monitoring and management** of deployment strategy resources
- **Compliance and governance** for deployment strategy activities
...
## Scripts
- `core/core/automation/ci-cd/scripts/deployment-strategy.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/deployment-strategy_handler.py`: Cloud-specific operations

...
# Generate Security Report — Multi-Cloud Enterprise Automation
...
## Scripts
- `core/core/automation/ci-cd/scripts/compliance-security-scanner.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/compliance-security-scanner_handler.py`: Cloud-specific operations

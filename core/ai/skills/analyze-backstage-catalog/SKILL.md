---
name: analyze-backstage-catalog
...
# Analyze Backstage Catalog — Multi-Cloud Enterprise Automation
...
## Scripts
- `core/core/automation/ci-cd/scripts/backstage-catalog.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/backstage-catalog_handler.py`: Cloud-specific operations

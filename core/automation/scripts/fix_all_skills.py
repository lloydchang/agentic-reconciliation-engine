...
## Scripts
- `core/core/automation/ci-cd/scripts/{skill_name}.py`: Main automation implementation
- `core/core/automation/ci-cd/scripts/{skill_name}_handler.py`: Cloud-specific operations

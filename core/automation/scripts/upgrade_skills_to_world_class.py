...
## Scripts
- `core/core/automation/ci-cd/scripts/{skill_name}.py`: Main automation with AI-powered analysis
- `core/core/automation/ci-cd/scripts/billing_analyzer.py`: Billing data processing
- `core/core/automation/ci-cd/scripts/recommendation_engine.py`: ML-based recommendations
- `core/core/automation/ci-cd/scripts/compliance_validator.py`: Compliance and audit checks
...
## Scripts
- `core/core/automation/ci-cd/scripts/{skill_name}.py`: Main automation with Kubernetes operations
- `core/core/automation/ci-cd/scripts/cluster_validator.py`: Cluster access and security validation
- `core/core/automation/ci-cd/scripts/command_generator.py`: kubectl command generation
- `core/core/automation/ci-cd/scripts/safety_analyzer.py`: Operation risk assessment

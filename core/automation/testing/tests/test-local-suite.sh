...
test_workloads() {
    ...
    kubectl apply -k core/resources/tenants/3-workloads/sample-apps/
...
test_monitoring() {
    ...
    kubectl apply -k core/resources/tenants/3-workloads/monitoring/
    ...
    if kubectl get crd helmreleases.helm.toolkit.fluxcd.io >/dev/null 2>&1 && \
       kubectl get crd helmrepositories.source.toolkit.fluxcd.io >/dev/null 2>&1; then
        kubectl apply -k core/resources/tenants/3-workloads/opentelemetry/
...
test_security() {
    ...
    kubectl apply -k core/resources/tenants/3-workloads/sealed-secrets/
    ...
    kubectl apply -k core/resources/tenants/3-workloads/opa-gatekeeper/
    ...
    kubectl apply -k core/resources/tenants/3-workloads/kyverno/
...
test_service_mesh() {
    ...
    kubectl apply -k core/resources/tenants/3-workloads/istio/
    ...
    kubectl apply -k core/resources/tenants/3-workloads/linkerd/
...
test_data() {
    ...
    kubectl apply -k core/resources/tenants/3-workloads/apache-kafka/
    ...
    kubectl apply -k core/resources/tenants/3-workloads/apache-airflow/
...
test_cicd() {
    ...
    kubectl apply -k core/resources/tenants/3-workloads/argo-cd/
    ...
    kubectl apply -k core/resources/tenants/3-workloads/argo-workflows/
    ...
    kubectl apply -k core/resources/tenants/3-workloads/kong-gateway/
...
generate_report() {
    ...
    echo "   - AI/ML: kubectl apply -k core/resources/tenants/3-workloads/kubeflow/"
    echo "   - GPU Support: kubectl apply -k core/resources/tenants/3-workloads/nvidia-gpu-operator/"
...
main() {
    ...
    echo "3. Run './core/automation/testing/drift-test.sh' for reconciliation testing"

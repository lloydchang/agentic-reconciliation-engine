...
test_aws_network_deps() {
    ...
    local aws_network_dir="core/resources/tenants/1-network"
    local errors=0
...
test_aws_cluster_deps() {
    ...
    local aws_cluster_dir="core/resources/tenants/2-clusters"
    local errors=0
...
test_azure_deps() {
    ...
    local azure_network_dir="core/resources/tenants/1-network"
    local azure_cluster_dir="core/resources/tenants/2-clusters"
    local errors=0
...
test_gcp_deps() {
    ...
    local gcp_network_dir="core/resources/tenants/1-network"
    local gcp_cluster_dir="core/resources/tenants/2-clusters"
    local errors=0
...
test_flux_kustomization_deps() {
    ...
    local flux_dir="core/operators/flux"
    local errors=0

...
# Configuration
AGENTS_DIR=".agents"
WORKSPACE_DIR="workspace/repo/.agents"
...
case "${1:-validate}" in
    ...
    "help"|"-h"|"--help")
        ...
        echo ""
        echo "Defaults:"
        echo "  If no directories specified, validates both .agents and workspace/repo/.agents"
        echo ""
        echo "Examples:"
        echo "  $0 validate                    # Validate all directories"
        echo "  $0 fix .agents                 # Fix naming in main .agents directory"
        echo "  $0 compliance workspace/repo/.agents  # Check compliance in workspace"
        ;;
    *)

...
echo "  ./scripts/disaster-recovery-drill.sh primary-outage"
echo "  ./scripts/disaster-recovery-drill.sh complete-outage"
echo "  ./scripts/disaster-recovery-drill.sh cache-failure"
echo ""

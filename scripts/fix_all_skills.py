...
def get_skill_description(skill_name):
    ...
    descriptions = {
        ...
        'kubernetes-cluster-manager': 'Manages Kubernetes cluster operations including provisioning, scaling, and maintenance across cloud providers. Use when administering clusters, managing node pools, or implementing cluster automation.',
        ...
        'secret-rotation': 'Automates secret rotation and management across multi-cloud environments with security best practices. Use when managing credentials, rotating secrets, or implementing security automation.',
        'sla-monitoring-alerting': 'Monitors SLA compliance and generates alerts for violations across multi-cloud services and applications. Use when tracking service levels, ensuring performance guarantees, or implementing SLA monitoring.',
        ...
        'secrets-certificate-manager': 'Manages secrets and certificates across multi-cloud environments with automated provisioning and renewal. Use when handling TLS certificates, managing secrets, or implementing security automation.',
        'backstage-catalog': 'Manages Backstage service catalog with automated service registration and metadata management. Use when implementing service catalogs, managing software assets, or organizing service information.',
        ...
        'k8s-troubleshoot': 'Provides intelligent troubleshooting guidance for Kubernetes issues across clusters and environments. Use when diagnosing K8s problems, resolving cluster issues, or implementing troubleshooting automation.',
        ...
        'slo-monitor': 'Monitors Service Level Objectives and generates alerts for violations across cloud services. Use when tracking SLOs, ensuring service quality, or implementing reliability monitoring.',
        ...
        'load-balancer-tuner': 'Optimizes load balancer configurations and performance across multi-cloud environments. Use when tuning load balancers, optimizing traffic distribution, or implementing performance optimization.',
        ...
        'workload-migration': 'Manages workload migration between cloud providers and environments with minimal downtime. Use when migrating workloads, changing providers, or implementing cloud migration.',
        ...
        'remediation-bot': 'Automatically remediates common infrastructure issues and security vulnerabilities across cloud environments. Use when fixing issues, implementing automation, or ensuring system health.',
        ...
        'developer-self-service': 'Provides self-service capabilities for developers to manage resources and deployments across cloud environments. Use when enabling developers, implementing self-service, or improving developer experience.',
        ...
        'security-analysis': 'Performs comprehensive security analysis across multi-cloud environments for threats and vulnerabilities. Use when conducting security assessments, identifying risks, or implementing security monitoring.',
        'network-diagnostics': 'Diagnoses and troubleshoots network issues across multi-cloud environments with intelligent analysis. Use when solving network problems, optimizing connectivity, or implementing network troubleshooting.',

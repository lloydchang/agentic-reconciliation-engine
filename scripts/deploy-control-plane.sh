...
mkdir -p "ai-agents/cmd/worker" "ai-agents/internal/workflow" "ai-agents/internal/activity" "ai-agents/internal/notifier"
...
# 3. Main AI Worker
cat <<EOF > ai-agents/cmd/worker/main.go
package main
import (
	"log"
...
# 4. Security Workflow
cat <<EOF > ai-agents/internal/workflow/security_drift.go
package workflow
...
cat <<EOF > ai-agents/internal/notifier/teams_template.go
package notifier

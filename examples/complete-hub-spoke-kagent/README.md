...
kubectl apply -f examples/complete-hub-spoke/          # Basic
kubectl apply -f examples/complete-hub-spoke-kagent/   # Enhanced
```
...
kubectl delete -f examples/complete-hub-spoke/
kubectl apply -f examples/complete-hub-spoke-kagent/
```
- Full replacement
- Enterprise features
